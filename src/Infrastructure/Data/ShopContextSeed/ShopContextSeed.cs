...
namespace Infrastructure.Data.ShopContextSeed
{
        ...
        static IEnumerable<Product> GetProducts()
        {
            return new List<Product>()
            {
                new Product
                {
                    ...
                    UnitPrice = 4599,
                    Photo = "TeoriV2-106778-8_small.jpg"
                },
                new Product
                {
                    CategoryId = 1,
                    ...
                    UnitPrice = 13999,
                    Photo = "TeoriV2-105261-7_small.jpg"
                },
                new Product
                {
                    CategoryId = 1,
                    ...
                    UnitPrice = 7899,
                    Photo = "TeoriV2-104421-2_small.jpg"
                },
                new Product
                {
                    CategoryId = 2,
                    ...
                    UnitPrice = 4499,
                    Photo = "TeoriV2-107814-1_small.jpg"
                },
                new Product
                {
                    CategoryId = 2,
                    ...
                    UnitPrice = 17599,
                    Photo = "TeoriV2-107655-1_small.jpg"
                },
                new Product
                {
                    CategoryId = 2,
                    ...
                    UnitPrice = 5299,
                    Photo = "TeoriV2-106885-1_small.jpg"
                },
                new Product
                {
                    CategoryId = 2,
                    ...
                    UnitPrice = 6199,
                    Photo = "TeoriV2-106777-1_small.jpg"
                },
                new Product
                {
                    CategoryId = 2,
                    ...
                    UnitPrice = 5599,
                    Photo = "TeoriV2-106571-1_small.jpg"
                },
                new Product
                {
                    CategoryId = 2,
                    ...
                    UnitPrice = 15973,
                    Photo = "TeoriV2-105824-2_small.jpg"
                },
                new Product
                {
                    CategoryId = 2,
                    ...
                    UnitPrice = 5043,
                    Photo = "TeoriV2-105445-8_small.jpg"
                },
                new Product
                {
                    CategoryId = 3,
                    ...
                    UnitPrice = 10218,
                    Photo = "TeoriV2-107585-2_small.jpg"
                },
                new Product
                {
                    CategoryId = 3,
                    ...
                    UnitPrice = 13583,
                    Photo = "TeoriV2-106836_small.jpg"
                },
                new Product
                {
                    CategoryId = 3,
                    ...
                    UnitPrice = 7499,
                    Photo = "TeoriV2-104420-1_small.jpg"
                },
                new Product
                {
                    CategoryId = 3,
                    ...
                    UnitPrice = 19999,
                    Photo = "TeoriV2-103978-1_small.jpg"
                }
            };
        }
    }
